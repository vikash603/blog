...
<head>
    ...
    <link rel="stylesheet" href="{{url('/')}}/backend/tag/src/bootstrap-tagsinput.css">
...
<body class="vertical-layout vertical-menu-modern dark-layout 2-columns  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="dark-layout">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="#"><i class="feather icon-copy"></i><span class="menu-title" data-i18n="Form Elements">Category</span></a>
                    <ul class="menu-content">
                        <li><a href="{{url('/')}}/category"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Select">Category</span></a>
                        </li>
                        <li><a href="{{url('/')}}/subcategory"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Switch">Sub Category</span></a>
                        </li>
                        <li><a href="{{url('/')}}/newstype"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Checkbox">News Type</span></a>
                        </li>
                        <li><a href="{{url('/')}}/news"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Radio">Add News</span></a>
                        </li>
                       
                        
                    </ul>
                </li>
                <li class=" nav-item"><a href="{{url('/')}}/about"><i class="feather icon-box"></i><span class="menu-title" data-i18n="Form Layout">About Us</span></a>
                </li>
                <li class=" nav-item"><a href="{{url('/')}}/contact"><i class="feather icon-package"></i><span class="menu-title" data-i18n="Form Wizard">Contact Us</span></a>
                </li>
                <li class=" nav-item"><a href="{{url('/')}}/newsads"><i class="feather icon-check-circle"></i><span class="menu-title" data-i18n="Form Validation">News Ads</span></a>
                </li>
    ...
    <script src="{{url('/')}}/backend/tag/jquery.min.js"></script>
<script src="{{url('/')}}/backend/tag/src/bootstrap-tagsinput.js"></script>
